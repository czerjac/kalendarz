...
t = t.replace("return array('id'=>$source.':'.$id,'title'=>$title,'content'=>$body,'fingerprint'=>hash('sha256',$title.\"\\n\".$body),'date_end'=>'2026-07-04','ready'=>$ready,'issues'=>array());", "return array('id'=>$source.':'.$id,'title'=>$title,'content'=>$body,'fingerprint'=>hash('sha256',$title.\"\\n\".$body),'date_start'=>'2026-07-04','date_end'=>'2026-07-04','ready'=>$ready,'issues'=>array());", 1)
t += r'''
